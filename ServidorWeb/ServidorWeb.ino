/* 
    ...
    Servidor Web - Exemplo da implementação de um servidor web que pega informações do sensor conectado ao ESP32

    Referência: https://capsistema.com.br/index.php/2020/12/03/interface-dht11-dht22-com-esp32-e-valores-de-exibicao-usando-servidor-web/
...
String SendHTML(float TempCstat,float Humiditystat){
  ...
  ptr +="<title>Curso ESP32 - PET</title>\n";
  ...
  ptr +="<body>\n";
   ...
   ptr +="<h1>PET Mecatronica/BSI - Curso de ESP32</h1>\n";
   ptr +="<h2>Boletim meteorologico ESP32</h2>\n";
   ptr +="<div class=\"data\">\n";
